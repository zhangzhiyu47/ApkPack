package com.stardict.shared.activities;
...
import com.stardict.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.stardict.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.stardict.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
